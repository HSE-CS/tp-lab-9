...
void print_sorted(std::function<Te(void)> initial_data_, std::function<bool(const Te &, const Te &)> comp) {
...
template <typename Te>
void print_sorted_test(std::vector<Te> initial_data, std::function<bool(const Te&, const Te&)> comp) {
...
int main() {
    ...
    std::function<bool(const std::string&, const std::string&)> example_string_comp =
