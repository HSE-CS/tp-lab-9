...
int main() {
    ...
    std::function<bool(std::string, std::string)> comp_2 =
            [](std::string str1, std::string str2) { return str1.back() < str2.back(); };
    exampleStrings = bubbleSort(exampleStrings, comp_2);
    print(exampleStrings);
    std::function<bool(std::string, std::string)> comp_3 = [](std::string str1,
                                                             std::string str2) {
    ...
    std::function<bool(std::string, std::string)> comp_4 =
            [](std::string str1, std::string str2) { return str1.size() < str2.size(); };
