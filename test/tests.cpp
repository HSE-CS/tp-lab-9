...
TEST(test, test_1) {
    ...
    BubbleSortParrallel(test_1, [](const std::string& first_, const std::string& second_) {
...
TEST(test, test_2) {
    ...
    BubbleSortParrallel(test_2, [](const std::string& first_, const std::string& second_) {
        return first_.length() > second_.length(); });
...
TEST(test, test_3) {
    ...
    BubbleSortParrallel(test_3, [](const std::string& first_, const std::string& second_) {
        return first_.length() > second_.length(); });
...
TEST(test, test_4) {
    ...
    BubbleSortParrallel(test_4, [](const std::string& first_, const std::string& second_) {
        return first_.length() > second_.length(); });
...
TEST(test, test_5) {
    ...
    BubbleSortParrallel(test_5, [](const std::string& first_, const std::string& second_) {
        return first_.length() > second_.length(); });
