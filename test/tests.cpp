...
TEST(lab9, test1) {
  ...
  {"yes", "mix", "my", "like", "is", "girls", "body", "blender", "am", "alcohol", "a", "I", "I", "Futurama", "Blackjack", "Bender"};
...
TEST(lab9, test2) {
  ...
  std::vector<std::string> expect =
  {"my", "body", "mix", "yes", "is", "girls", "blender", "Bender", "am", "alcohol", "Blackjack", "like", "a", "Futurama", "I", "I"};
  EXPECT_EQ(expect, Strings);
}
...
TEST(lab9, test3) {
  ...
  std::vector<std::string> expect =
  {"Futurama", "body", "Bender", "my", "mix", "is", "girls", "like", "yes", "blender", "alcohol", "Blackjack", "am", "a", "I", "I"};
  EXPECT_EQ(expect, Strings);
}
...
TEST(lab9, test4) {
  ...
  std::vector<std::string> expect =
  {"Blackjack", "Futurama", "blender", "alcohol", "Bender", "girls", "body", "like", "mix", "yes", "my", "is", "am", "a", "I", "I"};
  EXPECT_EQ(expect, Strings);
}
...
TEST(lab9, test5) {
  ...
  std::vector<std::string> expect =
  {"yes", "my", "mix", "like", "is", "girls", "body", "blender", "am", "alcohol", "a", "I", "I", "Futurama", "Blackjack", "Bender"};
  EXPECT_EQ(expect, Strings);
}
